...
TrkCorr_trkTriggered::TrkCorr_trkTriggered()
{
  ...
  for(int i = 0; i<nFiles; i++)
  {
    ...
    f[i] = TFile::Open(Form("corrHists_job%d_trkTriggered.root",i),"read");
...
double TrkCorr_trkTriggered::getArea(double eta1, double R)
{  
...
double TrkCorr_trkTriggered::getTrkCorr(float pt, float eta, int correction)
{
